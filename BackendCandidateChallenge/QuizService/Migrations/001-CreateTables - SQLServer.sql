...
ALTER TABLE [Answer] ADD CONSTRAINT [FK_Question_Answer] FOREIGN KEY([QuestionId]) REFERENCES [Question] ([Id]) ON DELETE CASCADE;
ALTER TABLE [Question] ADD  CONSTRAINT [FK_Answer_Question] FOREIGN KEY([CorrectAnswerId]) REFERENCES [Answer] ([Id])
